  ...
  return (
    <section id="testimonials" className="py-16 sm:py-28 px-4 sm:px-6">
      <div className="max-w-6xl 3xl:max-w-7xl mx-auto">
        ...
        <p className="text-muted-foreground text-xs uppercase tracking-[0.2em] text-center mb-8 sm:mb-16">
          {t.testimonials.subtitle}
        </p>

        {/* Mobile: stacked cards, Desktop: absolute positioned */}
        <div ref={ref} className="relative max-w-6xl 3xl:max-w-7xl mx-auto">
          ...
          {/* Mobile: flex column, Desktop: absolute */}
