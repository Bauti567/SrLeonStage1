      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t border-border">
          <div>
            ...
            <a href="https://www.instagram.com/bautii.__8/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 mt-3 hover:opacity-80 transition-opacity">
